...
call :cmdX xyo-cc --mode=%ACTION% @util/win-iconv.static.compile
call :cmdX xyo-cc --mode=%ACTION% @util/win-iconv.dynamic.compile
call :cmdX xyo-cc --mode=%ACTION% @util/iconv.compile
